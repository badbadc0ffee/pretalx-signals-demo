...
@receiver(review_form_html)
def review_form_html(sender, request, submission, **kwargs):
    return '<i class="fa fa-coffee mr-2"></i> Demo text below review form'
